...
function readDb() {
    ...
    try {
        ...
        return { numbers: [], admins: [MASTER_ADMIN], users: [], services: [], serviceRates: {}, balances: {}, withdrawals: [], apiUrls: [], checkDelay: 4000 };
    }
}
...
bot.hears("ℹ️ Help / Guide", async (ctx) => {
    ...
    helpText += `4️⃣ <b>/adminmenu:</b> Dynamic API, Delay এবং Custom Message ম্যানেজ করুন।\n`;
                            ...
                            if (rawMessage) {
                                ...
                                if (otpCode) {
                                    ...
                                    if (!userSentOtps.has(uniqueKey)) {
                                        ...
                                        // 2. গ্রুপের কাস্টমাইজড মেসেজ (মাস্ক করা নম্বর সহ)
