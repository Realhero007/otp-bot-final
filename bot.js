...
// --- Country Delivery Core Logic (UPDATED: Country + ISO + Price) ---
async function showCountriesList(ctx, serviceName) {
    ...
    countries.forEach((country, index) => {
        ...
        // Display format: 🇧🇩 Bangladesh [BD] - ৳0.5 BDT (Available)
...
// --- UPDATED: ADMIN ADD NUMBER WORKFLOW ---
